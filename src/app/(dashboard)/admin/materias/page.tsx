...
import { MateriaForm } from "@/components/forms";
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <MateriaForm onSuccess={() => { setOpen(false); fetchData(); }} />
          </DialogContent>
        </Dialog>
      </div>
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent>
          ...
          {editData && <MateriaForm initialData={editData} onSuccess={() => { setEditOpen(false); fetchData(); }} />}
        </DialogContent>
      </Dialog>
    </div>
  );
